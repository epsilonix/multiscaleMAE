...
# Set the blankoutbg parameter
ENABLE_BLANKOUTBG = True  # Change this to False if you do not want to enable blankoutbg
...
class Canvas:
    ...
    def load_dataset(self, batch_size = 64, num_workers = 40):
        ...
        dataset = SlidesDataset(
            ...
            blankoutbg=ENABLE_BLANKOUTBG  # Use the variable to set blankoutbg
        )
